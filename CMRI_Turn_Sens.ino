...
// PIN 21 cannot be used
  ...
  Throw[29] = 105;
  Close[29] = 85;
  myServos[29].attach(29);
  
  Throw[30] = 110;
  Close[30] = 80;
  myServos[30].attach(30);
 
  Throw[31] = 105;
  Close[31] = 85;
  myServos[31].attach(31);

  Throw[32] = 80;
  Close[32] = 105;
  myServos[32].attach(32);
  
  Throw[33] = 105;
  Close[33] = 80;
  myServos[33].attach(33);
  
  Throw[34] = 105;
  Close[34] = 80;
  myServos[34].attach(34);

  //Last and Dummy 4 Test
  Throw[40] = 80;
  Close[40] = 100;
  myServos[40].attach(40);
}
...
//     
 ...
 // PROCESS OUTPUTS
    ...
    //Used to control Relay for inversion loop
        digitalWrite(50, cmri.get_bit(100)); //Bit 100 = address 1100 in JMR
        digitalWrite(51, cmri.get_bit(101));
        digitalWrite(52, cmri.get_bit(102));  
        digitalWrite(53, cmri.get_bit(103));
